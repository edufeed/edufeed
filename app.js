...
(function(){
  var root, express, path, getsecret, throttle_call, deployd, func_cache, bing_api_key, Bing, app, server, io, ref$, dpd, get_image_url, get_image_url_throttled, get_image_url_cached, get_image_url_cached_throttled;

...
(function(){
  ...
  out$.getFeedWordList = getFeedWordList = function(){
    return ['cat', 'dog', 'ant', 'auto', 'ball', 'white', 'black', 'blue', 'red', 'bee', 'car', 'sun', 'egg', 'hat', 'bird', 'lion', 'tiger', 'fish', 'duck', 'city', 'house', 'roof', 'boat', 'tree', 'cold', 'corn', 'river', 'apple', 'india', 'milk', 'sock', 'sofa', 'rain', 'star', 'banana', 'cherry', 'orange', 'pear', 'broom', 'igloo', 'bicycle', 'carrot', 'chair', 'circle', 'square', 'cricket', 'dance', 'tennis', 'hockey', 'horse', 'house', 'table', 'train', 'lettuce', 'mouse', 'octopus', 'onion', 'paint', 'pencil', 'pillow', 'rabbit', 'read', 'sing', 'swim', 'write', 'zebra', 'draw'];
  };

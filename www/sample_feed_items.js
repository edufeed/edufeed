...
(function(){
  ...
  out$.getFeedWordList = getFeedWordList = function(){
    return ['cat', 'dog', 'ant', 'auto', 'ball', 'white', 'black', 'blue', 'red', 'bee', 'car', 'sun', 'egg', 'hat', 'bird', 'lion', 'tiger', 'fish', 'duck', 'city', 'house', 'roof', 'boat', 'tree', 'cold', 'corn', 'river', 'apple', 'india', 'milk', 'sock', 'sofa', 'rain', 'star', 'banana', 'cherry', 'orange', 'pear', 'broom', 'igloo', 'bicycle', 'carrot', 'chair', 'circle', 'triangle', 'square', 'cricket', 'dance', 'tennis', 'hockey', 'horse', 'house', 'table', 'train', 'lettuce', 'mouse', 'octopus', 'onion', 'paint', 'pencil', 'pillow', 'rabbit', 'read', 'sing', 'swim', 'write', 'zebra', 'draw'];
  };
  ...
  out$.getFillBlankSentencesWithCategories = getFillBlankSentencesWithCategories = function(){
    return [['My favorite color is ________.', 'color'], ['My favorite animal is the ________.', 'animal'], ['My favorite fruit is the ________.', 'fruit'], ['My favorite shape is the ________.', 'shape'], ['My favorite sport is ________.', 'sport'], ['My favorite vegetable is ________.', 'vegetable'], ['My favorite type of furniture is a ________.', 'furniture'], ['I like to ________.', 'activity'], ['My favorite type of weather is ________.', 'weather'], ['My favorite transportation is the ________.', 'transportation']];
  };
